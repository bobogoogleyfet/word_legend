// Word Legend patch: highp where the GPU offers it. mediump is 16-bit on many
// phone GPUs, too coarse for font-atlas coordinates: glyphs sampled slivers of
// their neighbours. Fragment shaders may lack highp, hence the guard.
#ifdef GL_ES
